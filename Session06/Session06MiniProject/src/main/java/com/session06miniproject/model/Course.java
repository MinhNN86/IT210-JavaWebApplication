package com.session06miniproject.model;

import java.time.LocalDate;

public class Course {
    private String code;         // Mã khóa học (vd: IELTS-6.5)
    ...
    private int studentCount;    // Số học viên hiện tại
    private boolean isFull;      // Trạng thái (đủ chỗ chưa)
